...
import { CollectionResourceMetadata } from '../interfaces/metadata/opra-schema.metadata.js';
import { TypeThunkAsync } from '../types.js';

const NESTJS_INJECTABLE_WATERMARK = '__injectable__';

export type CollectionResourceOptions = PartialSome<StrictOmit<CollectionResourceMetadata, 'kind' | 'type'>, 'keyFields'>;
