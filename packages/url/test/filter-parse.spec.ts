...
describe('Parsing Filter', function () {
  ...
  describe('parse terms', () => {
    ...
    it('Should parse BooleanLiteral', () => {
      ...
      expect(x.type).toStrictEqual('BooleanLiteral');
    ...
    it('Should parse NullLiteral', () => {
      ...
      expect(x.type).toStrictEqual('NullLiteral');
    ...
    it('Should parse NumberLiteral', () => {
      ...
      expect(x.type).toStrictEqual('NumberLiteral');
    ...
    it('Should parse StringLiteral', () => {
      let x = parseFilter('"1"');
      expect(x.type).toStrictEqual('StringLiteral');
      expect(x.value).toStrictEqual('1');
      expect('' + x).toStrictEqual("'1'");
      x = parseFilter('\'1\'');
      expect(x.type).toStrictEqual('StringLiteral');
    ...
    it('Should parse DateLiteral', () => {
      ...
      expect(x.type).toStrictEqual('DateLiteral');
    ...
    it('Should parse TimeLiteral', () => {
      ...
      expect(x.type).toStrictEqual('TimeLiteral');
    ...
    it('Should parse QualifiedIdentifier', () => {
      ...
      expect(x.type).toStrictEqual('QualifiedIdentifier');
    ...
    it('Should parse ExternalConstant', () => {
      const x = parseFilter('@arg1');
      expect(x.type).toStrictEqual('ExternalConstant');
      expect(x.value).toStrictEqual('arg1');
      expect('' + x).toStrictEqual('@arg1');
    })
  ...
  describe('parse expressions', () => {
    ...
    it('Should parse ParenthesesExpression', () => {
      ...
      expect(f.type).toStrictEqual('ParenthesesExpression');
      expect(f.expression.type).toStrictEqual('ArithmeticExpression');
    ...
    it('Should parse ArrayExpression', () => {
      ...
      expect(f.type).toStrictEqual('ArrayExpression');
      expect(Array.isArray(f.items)).toStrictEqual(true);
      expect(f.items.length).toStrictEqual(2);
      expect(f.items[0].type).toStrictEqual('NumberLiteral');
      expect(f.items[0].value).toStrictEqual(1);
      expect(f.items[1].type).toStrictEqual('StringLiteral');
    ...
    it('Should parse ComparisonExpression', () => {
      ...
      expect(f.type).toStrictEqual('ComparisonExpression');
      expect(f.op).toStrictEqual('=');
      expect(typeof f.left).toStrictEqual('object');
      expect(f.left.type).toStrictEqual('QualifiedIdentifier');
      expect(f.left.value).toStrictEqual('a');
      expect(typeof f.right).toStrictEqual('object');
      expect(f.right.type).toStrictEqual('NumberLiteral');
    ...
    it('Should parse LogicalExpression', () => {
      ...
      expect(f.type).toStrictEqual('LogicalExpression');
      expect(f.op).toStrictEqual('and');
      expect(Array.isArray(f.items)).toStrictEqual(true);
      expect(f.items.length).toStrictEqual(3);
      expect(f.items[0].type).toStrictEqual('ComparisonExpression');
      expect(f.items[1].type).toStrictEqual('ComparisonExpression');
      expect(f.items[2].type).toStrictEqual('ComparisonExpression');
    ...
    it('Should parse ParenthesesExpression', () => {
      ...
      expect(f.right.type).toStrictEqual('ParenthesesExpression');
      expect(f.right.expression.type).toStrictEqual('ArithmeticExpression');
