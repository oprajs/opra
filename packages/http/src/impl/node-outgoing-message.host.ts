 ...
 */
export class NodeOutgoingMessageHost
  extends Duplex
  implements NodeOutgoingMessage
{
  ...
  addTrailers(
    ...
    if (headers && typeof headers === 'object') {
      ...
      if (trailers == null) this[kOutTrailers] = trailers = { __proto__: null };
    ...
    throw new TypeError(
      'Invalid "headers" argument. Value must be an object or raw headers array',
    );
  }
  ...
  setHeaders(headers: Headers | Map<string, any> | Record<string, any>) {
    ...
    throw new TypeError(
      'Invalid "headers" argument. Value must be an instance of "Headers" or "Map"',
    );
  }
