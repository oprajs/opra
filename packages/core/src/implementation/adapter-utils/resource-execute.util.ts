import { BaseResource, EntityResource, OpraService } from '@opra/schema';
import { QueryContext } from '../query-context.js';
import { entityResourceExecute } from './entity-resource-execute.util.js';

export async function resourceExecute(service: OpraService, resource: BaseResource, context: QueryContext) {
