...
describe('Collection', function () {
  ...
  let customersResource: Collection;
  const data = {
    id: 1001,
    givenName: 'abcd',
    familyName: 'efgh',
  ...
  beforeAll(async () => {
    ...
    customersResource = document.getCollection('customers');
  });
  ...
  describe('"create" handler', function () {
    ...
    it('Should call handler', async () => {
      let ctx;
      const mockFn = jest.spyOn(customersResource.operations.create!, 'handler').mockImplementation((c) => ctx = c);
  ...
  describe('"delete" handler', function () {
    ...
    it('Should call handler', async () => {
      let ctx;
      const mockFn = jest.spyOn(customersResource.operations.delete!, 'handler').mockImplementation((c) => ctx = c);
  ...
  describe('"deleteMany" handler', function () {
    ...
    it('Should call handler', async () => {
      let ctx;
      const mockFn = jest.spyOn(customersResource.operations.deleteMany!, 'handler').mockImplementation((c) => ctx = c);
  ...
  describe('"get" handler', function () {
    ...
    it('Should call handler', async () => {
      let ctx;
      const mockFn = jest.spyOn(customersResource.operations.get!, 'handler').mockImplementation((c) => ctx = c);
  ...
  describe('"search" handler', function () {
    ...
    it('Should call handler', async () => {
      let ctx;
      const mockFn = jest.spyOn(customersResource.operations.search!, 'handler').mockImplementation((c) => ctx = c);
  ...
  describe('"update" handler', function () {
    ...
    it('Should call handler', async () => {
      let ctx;
      const mockFn = jest.spyOn(customersResource.operations.update!, 'handler').mockImplementation((c) => ctx = c);
  ...
  describe('"updateMany" handler', function () {
    ...
    it('Should call handler', async () => {
      let ctx;
      const mockFn = jest.spyOn(customersResource.operations.updateMany!, 'handler').mockImplementation((c) => ctx = c);
