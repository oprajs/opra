...
export function HttpOperationDecoratorFactory(
  ...
  options?: HttpOperation.Options & Pick<HttpOperation.Metadata, 'composition' | 'compositionOptions'>,
   ...
   *
   */
  decorator.Cookie = (name: string | RegExp, arg1?: StrictOmit<HttpParameter.Options, 'location'> | string | Type) => {
   ...
   *
   */
  decorator.Header = (name: string | RegExp, arg1?: StrictOmit<HttpParameter.Options, 'location'> | string | Type) => {
    decoratorChain.push((meta: HttpOperation.Metadata): void => {
      const paramMeta: HttpParameter.Metadata =
        typeof arg1 === 'string' || typeof arg1 === 'function'
          ? {
  ...
  decorator.Response = (
    ...
    const responseMeta: HttpOperationResponse.Metadata = { ...responseOptions, statusCode };
  ...
  decorator.RequestContent = function (arg0: any) {
    const contentMeta: HttpMediaType.Metadata = typeof arg0 === 'object' ? arg0 : { type: arg0 };
    if (contentMeta.type) {
  ...
  decorator.MultipartContent = function (
    ...
    if (subInit) {
      const configScope: MultipartContentScope = {
        Field(fieldName: string | RegExp, opts?: StrictOmit<HttpMultipartField.Options, 'fieldName' | 'fieldType'>) {
        ...
        File(fieldName: string | RegExp, opts?: StrictOmit<HttpMultipartField.Options, 'fieldName' | 'fieldType'>) {
          contentMetadata.multipartFields = contentMetadata.multipartFields || [];
          contentMetadata.multipartFields.push({
            fieldName,
            fieldType: 'file',
