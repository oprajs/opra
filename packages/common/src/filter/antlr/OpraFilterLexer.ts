...
export default class OpraFilterLexer extends Lexer {
  ...
  constructor(input: CharStream) {
    ...
    this._interp = new LexerATNSimulator(
      this,
      OpraFilterLexer._ATN,
      OpraFilterLexer.DecisionsToDFA,
  ...
  public static get _ATN(): ATN {
    if (!OpraFilterLexer.__ATN) {
      OpraFilterLexer.__ATN = new ATNDeserializer().deserialize(
  ...
  static DecisionsToDFA = OpraFilterLexer._ATN.decisionToState.map(
